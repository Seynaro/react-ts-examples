...
const EventsExample: FC = () => {
    ...
    return (
        <div>
            ...
            <div onDrag={dragHandler} draggable style={{width: 200, height: 200, background: 'red'}}>Hi</div>
            <div onDrop={dropHandler} onDragLeave={leaveHandler}
                onDragOver={dragWithPreventHandler}
                 style={{width: 200, height: 200, background: isDrag ? 'blue' : 'red', marginTop: 15}}>Bye</div>
        </div>
    );
};
